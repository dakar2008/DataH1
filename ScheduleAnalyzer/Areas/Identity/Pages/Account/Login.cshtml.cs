...
namespace ScheduleAnalyzer.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "Du skal indtaste en e-mail")]
            [EmailAddress(ErrorMessage = "Du skal indtaste en gyldig e-mail")]
            [Display(Name = "E-mail")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Ugyldig login information.");
                    return Page();
                }
            }
